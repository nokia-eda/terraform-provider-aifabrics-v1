...
const (
	create_rs_backend = "/apps/aifabrics.eda.nokia.com/v1/namespaces/{namespace}/backends"
	read_rs_backend   = "/apps/aifabrics.eda.nokia.com/v1/namespaces/{namespace}/backends/{name}"
	update_rs_backend = "/apps/aifabrics.eda.nokia.com/v1/namespaces/{namespace}/backends/{name}"
	delete_rs_backend = "/apps/aifabrics.eda.nokia.com/v1/namespaces/{namespace}/backends/{name}"
)
